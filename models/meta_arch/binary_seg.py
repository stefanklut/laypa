...
__all__ = [
    "BinarySegmentor",
    "BINARY_SEG_HEADS_REGISTRY",
    "BinarySegFPNHead",
    "build_binary_seg_head",
]


BINARY_SEG_HEADS_REGISTRY = Registry("BINARY_SEG_HEADS")
BINARY_SEG_HEADS_REGISTRY.__doc__ = """
Registry for binary segmentation heads, which make binary segmentation predictions
from feature maps.
"""


@META_ARCH_REGISTRY.register()
class BinarySegmentor(nn.Module):
    """
...
def build_binary_seg_head(cfg, input_shape):
    """
    Build a binary segmentation head from `cfg.MODEL.BINARY_SEG_HEAD.NAME`.
    """
    name = cfg.MODEL.BINARY_SEG_HEAD.NAME
    return BINARY_SEG_HEADS_REGISTRY.get(name)(cfg, input_shape)


@BINARY_SEG_HEADS_REGISTRY.register()
class BinarySegFPNHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if not len(input_shape):
            raise ValueError("BinarySegFPNHead(input_shape=) cannot be empty!")
