    ...
    def __init__(
        ...
        *,
        ...
        if num_classes is not None:
            self._logger.warning("SemSegEvaluator(num_classes) is deprecated! It should be obtained from metadata.")
        if ignore_label is not None:
            self._logger.warning("SemSegEvaluator(ignore_label) is deprecated! It should be obtained from metadata.")
